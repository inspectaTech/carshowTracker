...
export function ProfileCard({ profile }) {
  ...
  return (
    <div className="bg-[#04080bbf] rounded-xl w-[570px] h-full flex items-center gap-5 px-6 py-5">
      ...
      {/* Text Block */}
      <div className="flex flex-col gap-2 justify-center min-w-0 flex-1 h-full">
        {/* Name + verified */}
        <div className="flex items-center gap-2">
          <span className="text-white text-[28px] font-bold truncate">{profile.username}</span>
        ...
        {/* Handle */}
        <span className="text-[#777777] text-[20px]">{profile.handle}</span>

        {/* Bio */}
        <p className="text-[#AAAAAA] text-[16px] leading-snug line-clamp-2">{profile.bio}</p>

        {/* Location + Join date */}
        <div className="flex items-center gap-4 mt-1">
          <div className="flex items-center gap-1.5 text-[#888888] text-[14px]">
        ...
        {/* Social links */}
        <div className="flex items-center gap-4 text-[#888888] text-[14px] mt-1">
...
export function EditProfileButton() {
  return (
    <div className="absolute bottom-3 right-3 flex items-center gap-1.5 bg-[#0a0d12] border border-[#333333] rounded-md px-3 py-2 cursor-pointer hover:bg-[#0e1116] transition-colors">
...
export default function TopSection({ profile }) {
  return (
    <div className="flex flex-col gap-2.5 w-full">
      ...
      <div className="relative flex gap-2.5 h-[326px]">
